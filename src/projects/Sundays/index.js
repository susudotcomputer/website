    ...
    <>
      ...
      >
        <div className="max-w980px mx-auto">
          ...
          <main className="mb10">
            <section className="max-w600px mx-auto mb8 mb12-md bg-sususunday-red">
              <p className="fz20px lh1_5 fz24px-sm mb4">
                <span>
                ...
                <strong>How about you join us for SuSuSundays?</strong>
              </p>
              <p className="fz14px lh1_5 fz18px-sm mb4">
            ...
            <section className="flex flex-column max-w600px flex-row-sm max-w-none-sm mx-auto mb10 bg-sususunday-red">
              <div className="border border-white rounded mb4 mb0-sm">
                <a>
                  <img
                    src={mapImage}
                ...
                <p className="text-center p2 lh1_5">
                  <strong>803 43rd Ave, Long Island City, NY 11101</strong>
              ...
              <div className="ml4-sm border border-white rounded">
                <a>
                  <img
                    src={pinImage}
